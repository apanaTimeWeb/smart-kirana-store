...
export function AuthSignupHeader() {
  return (
    <div className="text-center mb-6">
      ...
      <h1 className="text-2xl font-bold tracking-tight text-[var(--auth-foreground)]">Naya Account</h1>
      <p className="text-[var(--auth-muted-text)] mt-1">2 minute mein setup karein</p>
    </div>
  );
}
