      ...
      <CardContent className="space-y-4">
        ...
        {form.gstEnabled && (
          <div className="space-y-1.5">
            <Label className="text-[var(--settings-foreground)]">{SettingsConstants.TEXTS.GST_NUMBER}</Label>
            <Input
              value={form.gstNumber}
              onChange={(e) => updateForm("gstNumber", e.target.value.toUpperCase())}
              placeholder={SettingsConstants.TEXTS.GST_NUMBER_PLACEHOLDER}
