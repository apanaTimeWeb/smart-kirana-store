  ...
  return (
    <div className="w-full max-w-sm">
      <div className="flex flex-col items-center mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">Apni dukaan mein wapas aayein</p>
      </div>

      <Card className="border shadow-sm">
        <CardHeader className="pb-4 pt-6 px-6">
          <h2 className="text-lg font-semibold">Login Karein</h2>
        ...
        <CardContent className="px-6 pb-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11 text-base font-semibold" disabled={loading}>
              {loading ? "Login ho raha hai..." : <span className="flex items-center gap-2">Login Karein <ArrowRight className="h-4 w-4" /></span>}
            </Button>
          </form>
